...
def litCricFriend(wordList, text):
    ...
    for word in split_text:
        string_list.append(word.strip(string.punctuation))
...
print(litCricFriend(definiteArticle,theBells))
print(litCricFriend(indefiniteArticles,cantoXII))
print(litCricFriend(definiteArticle,cantoXII))
...
# differently?
'''
Yes, Poe uses 'a' and 'an' more than Neruda. Yes, it shows they use 'the' differently.
'''
